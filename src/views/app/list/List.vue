...
<!--          <el-form-item>
            <el-button type="primary" v-showBtn="createAppGroup" @click="testVal()">Test</el-button>
          </el-form-item> -->
    ...
    <el-collapse accordion v-model="activeGroup">
      <el-collapse-item v-for="item in appgroups" :key="item.id" :name="item.id">
        ...
        <el-table :data="item.apps" v-loading="false" style="width: 100%;" v-if="item.apps.length > 0">
          ...
          <el-table-column label="内存" min-width="120" prop="mem" sortable>
          </el-table-column>

          <el-table-column label="当前状态" min-width="170" prop="status" sortable>
          </el-table-column>
<!--          <el-table-column prop="vclusterName" label="集群" min-width="200">
          ...
          <el-table-column label="版本" min-width="250" prop="version">
          </el-table-column>
            ...
            <template scope="scope">
              ...
              <el-dropdown>
                ...
                <el-dropdown-menu slot="dropdown">
                  ...
                  <el-button type="primary" v-showBtn="editApp" icon="edit" size="small">更新</el-button>
                  </router-link>
                  </el-dropdown-item>
                  <el-dropdown-item>
      ...
      <el-collapse-item :name="0" v-if="unversion.list.length > 0">
        <template slot="title">
          <el-row style="float: right;width:95%">
            ...
            <el-col :span="10">{{unversion.healthy}}/{{unversion.list.length}}</el-col>
          </el-row>
        </template>
        ...
        <el-table :data="unversion.list" v-loading="false" style="width: 100%;">
          ...
          <el-table-column label="所属" width="150" prop="owner" sortable>
          </el-table-column>

          <!--add by 2017年8月2日-->
          <el-table-column label="CPU" width="100" prop="cpus" sortable>
          </el-table-column>
          <el-table-column label="内存" width="100" prop="mem" sortable>
          </el-table-column>

          <el-table-column label="当前状态" width="120" prop="status">
          </el-table-column>
<!--          <el-table-column prop="vclusterName" label="集群" min-width="100">
          </el-table-column> -->
          <el-table-column prop="instances" label="实例" min-width="120" sortable>
          </el-table-column>
          ...
          <el-table-column label="更新时间" min-width="250" sortable>
            <template scope="test2">
          ...
          <el-table-column label="操作" min-width="200">
            <template scope="scope">
              ...
              <span v-if="scope.row.labels.PACKAGE_TYPE !== undefined">
                <el-button type="info" size="mini" @click="packageEdit(scope.row)">程序包更新</el-button>
              </span>
...
//          console.log('****************' + sessionStorage.getItem('activeGroup'))
        ...
        set: function (name) {
//          console.log('****************' + sessionStorage.getItem('activeGroup') + '============' + name)
          sessionStorage.setItem('activeGroup', name)
        }
      },
      ...mapState({
/*        marathonList (state) {
...
//          console.log(1111)
//          console.log(JSON.stringify(state.appgroups.arr))
//          console.log('*********************appgroups=' + JSON.stringify(appgroups))
          this.fullscreenLoading = false
          return appgroups
        },
        ...
        unversion (state) {
          let unversion = {}
          let healthy = 0
          for (let app of state.appgroups.unversion) {
            if (app.healthy > 0 || app.running > 0) {
              healthy += 1
            }
          }
...
//        console.log(this.page)
    ...
    methods: {
      ...
      testVal () {
        ...
        let val = localStorage.getItem('marathonName')
        console.log(val)
      },
      update (formName) {
...
//            let type = paras.labels.PACKAGE_TYPE
    ...
    //    this.IsShowUploadAddButton = fileList ? fileList.length > 0 : false
       ...
       //     this.IsShowUploadAddButton = false
            // 取消上传请求
...
//        var noticeMessage = this.$message
      ...
      editUser () {
        ...
        this.$store.dispatch(type.UPDATE_APP, {
          ...
          this.showResult(data, '更新所属用户成功', '更新所属用户失败', () => {
            this.listLoading = true
            this.listApp()
...
//          }
   ...
   //   window.localStorage.removeItem('marathonName') // 清除marathonName的值
