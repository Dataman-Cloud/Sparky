<template>
  <section>
    ...
    <el-form :label-position="labelPosition" :model="formName" label-width="85px" ref="formName"
      ...
      <el-form-item label="角色名称" prop="remarks" :rules="[
          { required: true, message: '请输入角色名称', trigger: 'blur' },
          {pattern: /^[A-Za-z]+$/, message: '角色名称只能包含字母', trigger: 'blur'},
          {max: 50, message: '长度不能超过50个字符', trigger: 'blur' }]">
        <el-col :span="4">
          <el-input type="text" v-model="formName.remarks"  placeholder="请输入角色名称">
          </el-input>
        </el-col>
      </el-form-item>
      ...
      <el-form-item label="描述" prop="name" :rules="[
          ...
          {max: 50, message: '长度不能超过50个字符', trigger: 'blur' }]">
        <el-col :span="8">
          <el-input type="text" v-model="formName.name" placeholder="请输入描述"></el-input>
        </el-col>
      </el-form-item>
